...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_gazebo_plugins_SOURCE_PREFIX /home/nalin/geo-matrix/ros-velodyne/simulator/src/velodyne_simulator/velodyne_gazebo_plugins)
  set(velodyne_gazebo_plugins_DEVEL_PREFIX /home/nalin/geo-matrix/ros-velodyne/simulator/devel)
  ...
  set(velodyne_gazebo_plugins_INSTALL_PREFIX /home/nalin/geo-matrix/ros-velodyne/simulator/install)
...
if(NOT "/home/nalin/geo-matrix/ros-velodyne/simulator/src/velodyne_simulator/velodyne_gazebo_plugins/include;/usr/include;/usr/include/gazebo-7;/usr/include/sdformat-4.0;/usr/include/ignition/math2;/usr/include/OGRE;/usr/include/OGRE/Terrain;/usr/include/OGRE/Paging " STREQUAL " ")
  set(velodyne_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/nalin/geo-matrix/ros-velodyne/simulator/src/velodyne_simulator/velodyne_gazebo_plugins/include;/usr/include;/usr/include/gazebo-7;/usr/include/sdformat-4.0;/usr/include/ignition/math2;/usr/include/OGRE;/usr/include/OGRE/Terrain;/usr/include/OGRE/Paging")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nalin/geo-matrix/ros-velodyne/simulator/src/velodyne_simulator/velodyne_gazebo_plugins/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nalin/geo-matrix/ros-velodyne/simulator/devel/lib;/home/nalin/geo-matrix/ros-velodyne/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
